from services.reel_extractor.reel_extractor_2 import get_reel_audio_cdn_link
import requests
import asyncio
...
async def main():
    ...
    if not cdn_link:
        cdn_link = get_reel_audio_cdn_link(url)
...
# curl "http://localhost:3000/api/video?postUrl=https://www.instagram.com/reel/DIHT_LcvHzI"
