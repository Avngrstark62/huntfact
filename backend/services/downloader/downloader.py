...
#         )
#
#         audio, err = process.communicate(timeout=timeout)
#
#         if process.returncode == 0 and audio:
#             return audio, "aac"   # 👈 mark format
#
#     except Exception:
#         pass
#
#     print("Fast path failed, falling back to MP3 re-encode...")
#
#     process = subprocess.Popen(
#         [
#             "ffmpeg",
